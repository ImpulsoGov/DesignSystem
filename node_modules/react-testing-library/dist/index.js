...
exports.cleanup = exports.renderIntoDocument = exports.fireEvent = exports.wait = exports.Simulate = exports.render = undefined;
...
function render(ui) {
  ...
  var containerHelpers = Object.entries(_domTestingLibrary.queries).reduce(function (helpers, _ref2) {
    var key = _ref2[0],
        fn = _ref2[1];
